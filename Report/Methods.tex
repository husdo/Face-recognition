...
have been developed such as those stated in \cite{literature_review} and \cite{FR_survey}.
As shown by M. J. Er \cite{RBF_NN} Neural Networks can be used to recognise faces. This requires a previous feature extraction to initialize the 
network. Convolutional Neural Networks (biologically-inspired Multilayer perceptron) are also popular for face recognition \cite{CNN}. We have 
