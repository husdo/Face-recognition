...
Computing of the new value of the central pixel, being the sum of powers of two combined with the value of neighbor taken clockwise.
\begin{figure}[ht]
\centering
...
Addition of histograms from subimages.
